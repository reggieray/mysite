Title: Bored Games Privacy Policy
Intro: "Privacy Policy for the Bored Games app."
NoIndex: true
SitemapItem: false
---
**Privacy Policy**

This privacy policy is applicable to the Bored Games app for mobile devices, together with any related services operated by Regis (collectively, the "Application"). Regis is hereinafter referred to as the "Service Provider".

**Data Controller Information**

Regis acts as the Data Controller responsible for the processing of your personal data.

*   Name: Regis
*   Address: 100 Suffolk Street Queensway, Aston Place, Birmingham, B1 1FJ, United Kingdom
*   Email: admin@matthewregis.dev
...
To request deletion of your personal data, withdraw consent, or exercise any of your rights, contact the Service Provider at admin@matthewregis.dev.
...
You have the right to request deletion of your personal data at any time, except where retention is required by law. If you'd like the Service Provider to delete User Provided Data that you have provided via the Application, please contact them at admin@matthewregis.dev and they will respond within the time required by applicable law. Please note that some User Provided Data may be required in order for the Application to function properly.

**Data Deletion**

You can request deletion of your personal data or account by contacting the Service Provider at admin@matthewregis.dev. The Service Provider will process your request within the timeframes required by applicable law.
...
Previous versions of this Privacy Policy will be maintained and made available upon request by contacting the Service Provider at admin@matthewregis.dev.
...
To exercise any of these rights, please contact the Service Provider at admin@matthewregis.dev. The Service Provider will verify your request using the information you provide and respond within the timeframes required by law. You may designate an authorized agent to make a request on your behalf.
...
If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at admin@matthewregis.dev.
